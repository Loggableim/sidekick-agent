...
# SIDEKICK_SESSION_SOURCE=tool so they don't clutter the user's session history.
...
def session_search(
    ...
    try:
        ...
        summaries = []
        for (session_id, match_info, conversation_text, session_meta), result in zip(tasks, results, strict=True):
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from runtime._compat.shim_state import DEFAULT_DB_PATH
