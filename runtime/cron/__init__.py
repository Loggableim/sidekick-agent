"""
|Cron job scheduling system for Sidekick Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    sidekick gateway install    # Install as a user service
    sudo sidekick gateway install --system  # Linux servers: boot-time system service
    sidekick gateway            # Or run in foreground
