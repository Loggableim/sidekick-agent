...
This adapter lets Sidekick use the ``google-gemini-cli`` provider as if it were
...
from runtime.google_code_assist import (
    ...
    def _create_chat_completion(
        ...
        **_: Any,
        ...
        headers = {
            ...
            "User-Agent": "sidekick-agent (gemini-cli-compat)",
            "X-Goog-Api-Client": "gl-python/sidekick",
...
def _gemini_http_error(response: httpx.Response) -> CodeAssistError:
    ...
    if status == 429 and error_reason == "MODEL_CAPACITY_EXHAUSTED":
        ...
        message = (
            ...
            f"not a Sidekick issue). Try a different Gemini model or set a "
        ...
        message = (
            ...
            f"retired. Check sidekick_cli/models.py for the current list."
        )
    elif err_message:
