"""
Sidekick -- HTTP helper functions.
"""
...
def _security_headers(handler):
    ...
    handler.send_header(
        ...
        "img-src 'self' data: https: blob:; font-src 'self' data: https://cdn.jsdelivr.net https://fonts.gstatic.com; connect-src 'self' https://cdn.jsdelivr.net http://192.168.1.110:* ws://192.168.1.110:*; "
