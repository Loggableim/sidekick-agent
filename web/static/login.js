...
document.addEventListener('DOMContentLoaded', function () {
  ...
  (function checkConnectivity() {
    ...
    function cleanupConnectivityProbe() {
      if (retryTimer !== null) {
        clearInterval(retryTimer);
        retryTimer = null;
      }
    }
    window.addEventListener('pagehide', cleanupConnectivityProbe, { once: true });
    window.addEventListener('beforeunload', cleanupConnectivityProbe, { once: true });
