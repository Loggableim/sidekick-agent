...
Used by ``sidekick kanban specify [task_id | --all]``. Takes a task that
...
* This module intentionally mirrors ``sidekick_cli/goals.py`` — same aux
...
_SYSTEM_PROMPT = """You are the Kanban triage specifier for the Sidekick Agent board.
...
def _profile_author() -> str:
    ...
    return (
        os.environ.get("SIDEKICK_PROFILE")
