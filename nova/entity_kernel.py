...
class EntityKernel:
    def __init__(self, space_dir: Path | None = None, state_provider: Callable[[], dict[str, Any]] | None = None):
        self.space_dir = Path(space_dir) if space_dir is not None else get_nova_space_root()
        self.state_provider = state_provider
        data_dir = get_nova_data_dir() if space_dir is None else self.space_dir / "entity_kernel"
        ...
        self.policy = AutonomyPolicy(policy_path if policy_path.exists() else HERE / "autonomy_policy.json")
