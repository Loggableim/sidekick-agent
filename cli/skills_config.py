"""
Skills configuration for Sidekick Agent.
`sidekick skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.sidekick/config.yaml under:
...
from cli.config import cfg_get, load_config, save_config
from cli.colors import Colors, color
from cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `sidekick skills`."""
    from cli.curses_ui import curses_checklist
