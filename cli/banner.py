...
Pure display functions with no SidekickCLI state dependency.
"""
...
from cli import __version__ as VERSION, __release_date__ as RELEASE_DATE

SIDEKICK_LOGO = (
    "[bold #FFD700]     _______. __   _______   _______  __  ___  __    ______  __  ___ [/]\n"
    "[bold #FFD700]    /       ||  | |       \\ |   ____||  |/  / |  |  /      ||  |/  / [/]\n"
    "[#FFBF00]   |   (----`|  | |  .--.  ||  |__   |  '  /  |  | |  ,----'|  '  /  [/]\n"
    "[#FFBF00]    \\   \\    |  | |  |  |  ||   __|  |    <   |  | |  |     |    <   [/]\n"
    "[#CD7F32].----)   |   |  | |  '--'  ||  |____ |  .  \\  |  | |  `----.|  .  \\  [/]\n"
    "[bold #CD7F32]|_______/    |__| |_______/ |_______||__|\\__\\ |__|  \\______||__|\\__\\ [/]\n"
...
def format_banner_version_label() -> str:
    ...
    base = f"Sidekick Agent v{VERSION} ({RELEASE_DATE})"
...
def build_welcome_banner(console: Console, model: str, cwd: str,
    ...
    try:
        ...
        if behind is not None and behind != 0:
            from cli.config import get_managed_update_command, recommended_update_command
            if behind > 0:
                ...
                # UPDATE_AVAILABLE_NO_COUNT: nix-built sidekick; we know an update
