...
~/.sidekick/channel_directory.json.  The send_message tool reads this file for
...
DIRECTORY_PATH = get_sidekick_home() / "channel_directory.json"
...
async def build_channel_directory(adapters: Dict[Any, Any]) -> Dict[str, Any]:
    ...
    """
    from runtime.gateway.config import Platform
...
def _build_from_sessions(platform_name: str) -> List[Dict[str, str]]:
    ...
    sessions_path = get_sidekick_home() / "sessions" / "sessions.json"
